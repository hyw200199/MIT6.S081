...
int main(int argc, char **argv) {
  ...
  18:	19e080e7          	jalr	414(ra) # 1b2 <atoi>
  ...
  32:	79a50513          	addi	a0,a0,1946 # 7c8 <malloc+0xe4>
  36:	00000097          	auipc	ra,0x0
  3a:	5f0080e7          	jalr	1520(ra) # 626 <printf>
...
gets(char *buf, int max)
{
 ...
 12e:	19c080e7          	jalr	412(ra) # 2c6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 190:	17a080e7          	jalr	378(ra) # 306 <fstat>
 194:	892a                	mv	s2,a0
  close(fd);
 196:	8526                	mv	a0,s1
 198:	00000097          	auipc	ra,0x0
 19c:	13e080e7          	jalr	318(ra) # 2d6 <close>
  return r;
}
 1a0:	854a                	mv	a0,s2
